...
export const Cart: React.FC = () => {
  ...
  if (cart.length === 0) {
    return (
      <div className="h-[70vh] flex flex-col items-center justify-center pt-24 text-center px-4">
        ...
        <h2 className="text-4xl font-display font-bold mb-4">Ваш кошик порожній</h2>
        <p className="text-white/50 mb-8 max-w-sm">Відкрийте для себе нашу фірмову колекцію та знайдіть ідеальний звук для свого простору.</p>
  ...
  return (
    <div className="pt-24 pb-24 max-w-7xl mx-auto px-4">
      <h1 className="text-4xl font-display font-bold mb-12">Перевірте свій кошик</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div className="lg:col-span-1">
          <div className="glass-card p-8 rounded-3xl sticky top-28">
            <h2 className="text-2xl font-bold mb-8">Підсумок замовлення</h2>
            <div className="space-y-4 mb-8">
              ...
              <div className="flex justify-between text-white/50">
                <span>Доставка</span>
                <span className="text-white">Безкоштовно</span>
              </div>
            ...
            <div className="space-y-4 text-xs text-white/30 text-center">
              <p>Варіанти фінансування доступні під час оформлення.</p>
              <button onClick={clearCart} className="hover:text-white transition-colors underline">Очистити кошик</button>
            </div>
          </div>
        </div>
      </div>
